...
public class OsmTerrainOptions extends TerrainOptions {
    ...
    public OsmTerrainOptions(double latStep, double zoomFrom, int maxTerrainViewDistance, TerrainCompression compression) {
        super(TERRAIN_OSM, latStep, zoomFrom, compression);
