...
public class AltitudeTerrainOptions extends TerrainOptions {
    ...
    public AltitudeTerrainOptions(double latStep, double zoomFrom, int maxTerrainViewDistance, int gridSize,
                                  TerrainCompression compression) {
        super(TERRAIN_ALTITUDE, latStep, zoomFrom, compression);
